...
**Design DNA — `editorial` / editorial / ink**
- Layout family: `masthead` — Masthead, a column, a pull quote. Boxes are optional.
...
- Type: Masthead weight, pull-quote size, body 60-75ch.
- Execute: Ink on paper. Rules, not cards. A pull quote is the only oversized moment besides the mechanic.
...
- Invariant (unit-test this): Cook mode: ingredients checked, then numbered steps. Dish-of-the-day is optional chrome.
- Empty: The cookbook is empty.
- Fake that fails: A recipe search without cook mode.
- Never: Not a shop.
